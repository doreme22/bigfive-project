...
export const questions = [
  ...
  { id: 16, text: '我可能会害羞或拘谨',                 dimension: 'E', reverse: false },
  { id: 17, text: '我对绝大多数人都很友善',             dimension: 'A', reverse: false },
  { id: 18, text: '我可能有点粗心',                     dimension: 'C', reverse: true },
  { id: 19, text: '我情绪稳定，不易心烦意乱',           dimension: 'N', reverse: false },
  ...
  { id: 24, text: '我总是担心很多事情',                 dimension: 'N', reverse: true },
  ...
  { id: 31, text: '我有时会感到忧郁或沮丧',             dimension: 'E', reverse: false },
  { id: 32, text: '我更喜欢常规性的工作',               dimension: 'A', reverse: false },
  ...
  { id: 36, text: '我倾向于挑起和别人的争执',           dimension: 'E', reverse: true },
  { id: 37, text: '我是一个可信赖的工作者',             dimension: 'A', reverse: false },
  { id: 38, text: '我很容易分心',                       dimension: 'C', reverse: false },
  { id: 39, text: '我很容易感到焦虑',                   dimension: 'N', reverse: false },
  { id: 40, text: '我生性宽容',                         dimension: 'O', reverse: false },
  { id: 41, text: '我觉得我缺乏独创力',                 dimension: 'O', reverse: true },
  { id: 42, text: '我往往怀疑别人的动机',               dimension: 'A', reverse: true },
  { id: 43, text: '我做决定很果断',                     dimension: 'C', reverse: true },

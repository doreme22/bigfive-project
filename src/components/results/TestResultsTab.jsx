    ...
    <div>
      <div className="flex items-start gap-3">
        <div className="flex-1 min-w-0">
          <div className="relative h-[6px] bg-[#F1F2F4] rounded-full w-full">
            <div
...
const dimensionDescriptions = {
  ...
  A: '反映人际互动中的合作与信任倾向。高分者友善包容、善于合作；低分者直率坦白，不轻易迁就。',
...
export default function TestResultsTab({ scores, section }) {
  // Render only radar section
  if (section === 'radar') {
    return (

...
**适合的公司类型**
重视个人发展和学习文化的组织——知识密集型行业的成长型公司，或鼓励员工自我探索的创新团队

**适合的团队角色**
团队中的"翻译者"和"连接者"——你对人的敏感度让你能理解不同性格成员的需求，在团队中起到桥梁作用

**理想搭档画像**
你需要一个**行动力强的搭档**帮你把洞察转化为成果，以及一个**开放包容的上级**给你探索空间

**最适合的岗位类型**
人才发展/组织发展、用户研究/产品策略、咨询/教练

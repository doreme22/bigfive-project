...
export function buildPrompt(scores, resume) {
  ...
  return `角色定位：你是一位精通心理学和职业规划的顶级专家，擅长从干燥的分数和简历文字中，还原一个活生生的人。基于用户的 BFI-44 测评均分 {${scoresStr}}（常模参考：{${normsStr}}）和用户简历内容 {${resume}}。请写出一份极具洞察力的分析。
任务指令：请按以下结构撰写深度报告，一定要结合简历中的具体经历和专业职业背景
1. 性格底色
别复述分数，而是描述他是一个怎样的人，尤其要挖掘分数中最不和谐或最和谐的张力点，描述这种特质如何在他身上拉扯或共生。
2. 经历复盘
必须引用简历中的具体项目经历。分析该经历是"顺着天性"还是"逆着天性"，解释其成功或痛苦的底层逻辑。
3. 职场推演
